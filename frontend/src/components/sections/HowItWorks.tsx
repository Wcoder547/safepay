...
export function HowItWorks() {
  ...
  return (
    <section className="relative overflow-hidden bg-linear-to-b from-slate-50 to-white py-28">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="relative mt-16 grid gap-6 md:grid-cols-3">
          <div className="absolute left-1/2 top-12 hidden h-px w-2/3 -translate-x-1/2 bg-linear-to-r from-transparent via-blue-200 to-transparent md:block" />
          {steps.map((s, i) => (
            <div key={s.n} className="group relative rounded-2xl border border-slate-200 bg-white/80 p-8 backdrop-blur transition hover:border-blue-300 hover:shadow-xl">
              <div className="flex items-center justify-between">
                <div className="relative flex h-12 w-12 items-center justify-center rounded-xl bg-linear-to-br from-blue-600 to-indigo-700 text-sm font-bold text-white shadow-lg shadow-blue-600/30">{s.n}</div>
        ...
        <div className="mt-14 text-center">
          <Button size="lg" className="h-12 rounded-full bg-linear-to-r from-blue-600 to-indigo-600 px-7 text-base shadow-lg shadow-blue-600/30 hover:shadow-xl">
