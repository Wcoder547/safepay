...
export function SignInPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/40 to-white flex items-center justify-center px-4">
      {/* Background blobs */}
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="rounded-2xl border border-slate-200/60 bg-white/80 p-8 shadow-xl shadow-slate-200/50 backdrop-blur-xl">
          ...
          <p className="mt-1 text-sm text-slate-500">Enter your phone number and password</p>
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            ...
            <Link to="/sign-up" className="font-semibold text-blue-600 hover:text-blue-700">Create one</Link>
          </p>
        </div>
